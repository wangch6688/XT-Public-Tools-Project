...
/**
 是否单选 YES 为单选，默认为YES 在设置了 singleFlagArr 属性后 则该属性无效
 */
@property (assign, nonatomic) BOOL isShowNoAddCount;
...
/// 当内容超过时是否可以滚动，还是自适应并把返回自适应的高度，默认可以滚动
@property (assign, nonatomic) BOOL isScrollView;
...
@property (strong, nonatomic) UIColor * norBorderColor;
/**
 backgroundColor颜色
 */
...
@property (strong, nonatomic) UIColor * enabColor;
@property (strong, nonatomic) UIColor * selBorderColor;
@property (strong, nonatomic) UIColor * enabBorderColor;
/**
 文字默认颜色
 */
...
/**
 文字不可用颜色
 */
@property (strong, nonatomic) UIColor * contentEnabColor;
/**
 文字字体
 */
...
//隔离距离 默认为 15
@property (assign, nonatomic) CGFloat maragin;
...
/**
设置默认选择多少个，传的是index，需要小于 最小数据组的count，
isDefaultEna为 YES 时才起作用
传入的下标 请用 NSNumber
当设置了 singleFlagArr 属性时，defaultSelectIndexArr 会监测元素是否为 数组，并当singleFlagArr的元素个数为1即单选
时，则会修改为多选[{section:0,rows:[1,2]}]]
*/
@property (copy, nonatomic) NSArray* defaultEnableIndexArr;
...
/// 设置可用的按钮
/// @param defaultEnableIndexArr 可用按钮数组
/// @param ignoreArray 忽略的组号数组，
